 ...
 * 募集用のキャンバス(1枚目)を作成する
 */
async function recruitAnarchyCanvas(recruit_num, count, host_member, user1, user2, condition, rank, channel_name) {
 ...
 */
async function ruleAnarchyCanvas(anarchy_data, thumbnail) {
