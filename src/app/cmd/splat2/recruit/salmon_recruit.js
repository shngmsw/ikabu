...
Canvas.registerFont(path.resolve('src/fonts/Splatfont.ttf'), {
    family: 'Splatfont',
});
Canvas.registerFont(path.resolve('src/fonts/GenShinGothic-P-Medium.ttf'), {
    family: 'Genshin',
});
Canvas.registerFont(path.resolve('src/fonts/GenShinGothic-P-Bold.ttf'), {
    family: 'Genshin-Bold',
});
