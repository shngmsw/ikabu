...
module.exports = {
    recruitSalmonCanvas: recruitSalmonCanvas,
    ruleSalmonCanvas: ruleSalmonCanvas,
};
...
async function recruitSalmonCanvas(recruit_num: $TSFixMe, count: $TSFixMe, host_member: $TSFixMe, user1: $TSFixMe, user2: $TSFixMe, condition: $TSFixMe, channel_name: $TSFixMe) {
 ...
 */
// @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'ruleSalmon... Remove this comment to see the full error message
async function ruleSalmonCanvas(data: $TSFixMe) {
    ...
    // @ts-expect-error TS(2304): Cannot find name 'stage_width'.
