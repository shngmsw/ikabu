...
export async function recruitAnarchyCanvas(
  ...
  let anarchy_icon = await Canvas.loadImage(
 ...
 */
export async function ruleAnarchyCanvas(
  ...
  const time =
    formatDatetime(anarchy_data.startTime, dateformat.hm) +
    " - " +
    formatDatetime(anarchy_data.endTime, dateformat.hm);
  ...
  let rule_width = rule_ctx.measureText(anarchy_data.rule).width;
  fillTextWithStroke(
    rule_ctx,
    anarchy_data.rule,
    "45px Splatfont",
  ...
  let stage1_width = rule_ctx.measureText(anarchy_data.stage1).width;
  fillTextWithStroke(
    rule_ctx,
    anarchy_data.stage1,
    "35px Splatfont",
  ...
  let stage2_width = rule_ctx.measureText(anarchy_data.stage2).width;
  fillTextWithStroke(
    rule_ctx,
    anarchy_data.stage2,
    "35px Splatfont",
