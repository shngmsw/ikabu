...
module.exports = {
    ...
    ruleAnarchyCanvas: ruleAnarchyCanvas,
};
...
async function recruitAnarchyCanvas(recruit_num: $TSFixMe, count: $TSFixMe, host_member: $TSFixMe, user1: $TSFixMe, user2: $TSFixMe, condition: $TSFixMe, rank: $TSFixMe, channel_name: $TSFixMe) {
 ...
 */
// @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'ruleAnarch... Remove this comment to see the full error message
async function ruleAnarchyCanvas(anarchy_data: $TSFixMe, thumbnail: $TSFixMe) {
