...
async function recruitBigRunCanvas(recruit_num: $TSFixMe, count: $TSFixMe, host_member: $TSFixMe, user1: $TSFixMe, user2: $TSFixMe, condition: $TSFixMe, channel_name: $TSFixMe) {
    try {
 ...
 */
// @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'ruleBigRun... Remove this comment to see the full error message
async function ruleBigRunCanvas(data: $TSFixMe) {
    try {
