...
async function recruitFesCanvas(recruit_num: $TSFixMe, count: $TSFixMe, host_member: $TSFixMe, user1: $TSFixMe, user2: $TSFixMe, team: $TSFixMe, color: $TSFixMe, condition: $TSFixMe, channel_name: $TSFixMe) {
 ...
 */
// @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'ruleFesCan... Remove this comment to see the full error message
async function ruleFesCanvas(fes_data: $TSFixMe) {
