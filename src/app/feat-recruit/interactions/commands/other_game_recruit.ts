...
const { recruitActionRow, embedRecruitDeleteButton, unlockChannelButton } = require('../../buttons/create_recruit_buttons')
...
async function otherGameRecruit (interaction: $TSFixMe) {
  // subCommands取得
...
async function sendOtherGames (interaction: $TSFixMe, title: $TSFixMe, recruitNumText: $TSFixMe, mention: $TSFixMe, txt: $TSFixMe, color: $TSFixMe, image: $TSFixMe, logo: $TSFixMe) {
  const options = interaction.options
