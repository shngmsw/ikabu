 ...
 * @returns
 */
async function handleError (err: $TSFixMe, {
  interaction
}: $TSFixMe) {
...
async function join (interaction: $TSFixMe, params: $TSFixMe) {
 ...
 * @returns
 */
async function cancel (interaction: $TSFixMe, params: $TSFixMe) {
  /** @type {Discord.Snowflake} */
  try {
    await interaction.update({ components: await setButtonDisable(interaction.message, interaction) })
...
async function del (interaction: $TSFixMe, params: $TSFixMe) {
  /** @type {Discord.Snowflake} */
  try {
    // 処理待ち
 ...
 * @returns
 */
async function close (interaction: $TSFixMe, params: $TSFixMe) {
  /** @type {Discord.Snowflake} */
  try {
    await interaction.update({ components: await setButtonDisable(interaction.message, interaction) })
...
async function joinNotify (interaction: $TSFixMe, params: $TSFixMe) {
  /** @type {Discord.Snowflake} */
  try {
    await interaction.update({ components: await setButtonDisable(interaction.message, interaction) })
...
async function cancelNotify (interaction: $TSFixMe, params: $TSFixMe) {
  /** @type {Discord.Snowflake} */
  try {
    await interaction.update({ components: await setButtonDisable(interaction.message, interaction) })
...
async function closeNotify (interaction: $TSFixMe, params: $TSFixMe) {
  /** @type {Discord.Snowflake} */
  try {
    await interaction.update({ components: await setButtonDisable(interaction.message, interaction) })
...
async function unlock (interaction: $TSFixMe, params: $TSFixMe) {
  /** @type {Discord.Snowflake} */
...
function getMemberMentions (members: $TSFixMe) {
