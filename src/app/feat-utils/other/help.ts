        ...
        new EmbedBuilder()
          ...
          .addFields([
            ...
            },
            {
              name: "/ボイスロック vclock",
              value:
                "```今いるVCに人数制限を設定。ゲームに集中したい場合に使ってください。```",
              inline: true,
            },
            {
            ...
            },
            {
              name: "/チーム分け team",
              value:
                "```チームごとの勝率が均等になるようにチーム分けします。勝率1位と2位は別チームになります。```",
              inline: true,
            },
          ]),
      ],
          ...
          .addFields([
            {
              name: "/プラベ募集 recruit",
              value:
                "```開始時刻 所要時間 募集人数 内容または参加条件があれば記載```",
            },
            {
              name: "/プラベ募集 button",
              value:
                "```everyone通知と参加ボタンのみ表示。通常のチャットでプラベ概要を書いた後に使ってください。```",
            },
            {
              name: "/バンカラ募集 now",
