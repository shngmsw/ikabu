...
const voiceLock = new SlashCommandBuilder()
  ...
  .addSubcommand((subcommand: $TSFixMe) => subcommand
  .setName('vclock')
  .setDescription('このボイスチャンネルに人数制限をかけます')
  .addIntegerOption((option: $TSFixMe) => option.setName('人数').setDescription('制限人数を指定する場合は1～99で指定してください。').setRequired(false)
  )
  )
...
const friendCode = new SlashCommandBuilder()
  ...
  .addStringOption((option: $TSFixMe) => option.setName('フレンドコード').setDescription('例：SW-0000-0000-0000').setRequired(true))
  )
  .addSubcommand((subcommand: $TSFixMe) => subcommand.setName('show').setDescription('登録したフレンドコードを表示します。未登録の場合は自己紹介から引用します。')
  )
...
const kansen = new SlashCommandBuilder()
  ...
  .addIntegerOption((option: $TSFixMe) => option.setName('回数').setDescription('何回分の組み合わせを抽出するかを指定します。5回がおすすめ').setRequired(true)
  )

const minutesTimer = new SlashCommandBuilder()
  .setName(commandNames.timer)
  .setDescription('分タイマー')
  .addIntegerOption((option: $TSFixMe) => option.setName('分').setDescription('〇〇分後まで1分ごとにカウントダウンします。').setRequired(true))

const pick = new SlashCommandBuilder()
  .setName(commandNames.pick)
  .setDescription('選択肢の中からランダムに抽出します。')
  .addStringOption((option: $TSFixMe) => option.setName('選択肢').setDescription('半角スペースで区切って入力してください。').setRequired(true))
  .addIntegerOption((option: $TSFixMe) => option.setName('ピックする数').setDescription('2つ以上ピックしたい場合は指定してください。').setRequired(false)
  )

const vpick = new SlashCommandBuilder()
  .setName(commandNames.voice_pick)
  .setDescription('VCに接続しているメンバーからランダムに抽出します。')
  .addIntegerOption((option: $TSFixMe) => option.setName('ピックする人数').setDescription('2人以上ピックしたい場合は指定してください。').setRequired(false)
  )
...
const buki = new SlashCommandBuilder()
  ...
  .addIntegerOption((option: $TSFixMe) => option.setName('ブキの数').setDescription('指定するとn個のブキをランダムに選びます。').setRequired(false))
  .addStringOption((option: $TSFixMe) => option
  .setName('ブキ種')
...
const chManager = new SlashCommandBuilder()
  ...
  .addAttachmentOption((option: $TSFixMe) => option
  .setName('csv')
  ...
  .addStringOption((option: $TSFixMe) => option.setName('ロール名').setDescription('ロール名を指定してください。').setRequired(true))
  .addStringOption((option: $TSFixMe) => option.setName('ロールカラー').setDescription('カラーコードをhexで入力してください。').setRequired(false)
  )
  )
  .addSubcommand((subcommand: $TSFixMe) => subcommand
  .setName('ロール割当')
  .setDescription('ロール割当')
  .addMentionableOption((option: $TSFixMe) => option.setName('ターゲットロール').setDescription('どのロールにつけますか？').setRequired(true)
  )
  .addMentionableOption((option: $TSFixMe) => option.setName('割当ロール').setDescription('どのロールをつけますか？').setRequired(true))
  )
  .addSubcommand((subcommand: $TSFixMe) => subcommand
  .setName('ロール解除')
  .setDescription('ロール解除')
  .addMentionableOption((option: $TSFixMe) => option.setName('ターゲットロール').setDescription('どのロールから外しますか？').setRequired(true)
  )
  .addMentionableOption((option: $TSFixMe) => option.setName('解除ロール').setDescription('どのロールを外しますか？').setRequired(true))
  )
  .addSubcommand((subcommand: $TSFixMe) => subcommand
  .setName('ロール削除')
  .setDescription('ロール削除')
  .addMentionableOption((option: $TSFixMe) => option.setName('ロール名1').setDescription('ロール名を指定してください。').setRequired(true))
  .addMentionableOption((option: $TSFixMe) => option.setName('ロール名2').setDescription('ロール名を指定してください。').setRequired(false))
  .addMentionableOption((option: $TSFixMe) => option.setName('ロール名3').setDescription('ロール名を指定してください。').setRequired(false)
  )
  )
  .addSubcommand((subcommand: $TSFixMe) => subcommand
  .setName('カテゴリー削除')
  ...
  .addStringOption((option: $TSFixMe) => option.setName('カテゴリーid').setDescription('カテゴリーIDを半角スペース区切りで指定').setRequired(false)
  )
  )
  .addSubcommand((subcommand: $TSFixMe) => subcommand
  .setName('チャンネル削除')
  .setDescription('チャンネル削除')
  .addStringOption((option: $TSFixMe) => option.setName('チャンネルid').setDescription('チャンネルIDをを半角スペース区切りで指定').setRequired(true)
  )
  )
...
const regularMatch = new SlashCommandBuilder()
  ...
  .addIntegerOption((option: $TSFixMe) => option
  .setName('募集人数')
  ...
  .addChannelOption((option: $TSFixMe) => option
  .setName('使用チャンネル')
  .setDescription('使用するボイスチャンネルを指定できます。')
  .addChannelTypes(ChannelType.GuildVoice)
  .setRequired(false)
  )
  .addUserOption((option: $TSFixMe) => option.setName('参加者1').setDescription('既に決定している参加者を指定してください。').setRequired(false)
  )
  .addUserOption((option: $TSFixMe) => option.setName('参加者2').setDescription('既に決定している参加者を指定してください。').setRequired(false)
  )
  .addUserOption((option: $TSFixMe) => option.setName('参加者3').setDescription('既に決定している参加者を指定してください。').setRequired(false)
  )
  )
  .addSubcommand((subcommand: $TSFixMe) => subcommand
  .setName('next')
...
const privateMatch = new SlashCommandBuilder()
  ...
  .addStringOption((option: $TSFixMe) => option.setName('所要時間').setDescription('何時間ぐらいやる？例：2時間').setRequired(true))
...
const otherGame = new SlashCommandBuilder()
  ...
  .addStringOption((option: $TSFixMe) => option.setName('ゲームタイトル').setDescription('ゲームタイトルを入力してください。').setRequired(true)
  )
  .addStringOption((option: $TSFixMe) => option.setName('募集人数').setDescription('募集人数 (自由入力)').setRequired(true))
  .addStringOption((option: $TSFixMe) => option.setName('内容または参加条件').setDescription('プレイ内容や参加条件など'))
  )
...
const teamDivider = new SlashCommandBuilder()
  ...
  .addIntegerOption((option: $TSFixMe) => option.setName('各チームのメンバー数').setDescription('それぞれのチームメンバー数(ex: スプラ=4, valo=5)').setRequired(true)
  )
  .addBooleanOption((option: $TSFixMe) => option.setName('勝利数と勝率を隠す').setDescription('勝利数と勝率を隠すことができます。'))
  )
...
const voiceChannelMention = new SlashCommandBuilder()
  ...
  .addStringOption((option: $TSFixMe) => option.setName('メッセージ').setDescription('メンションと一緒に送るメッセージを入力します。').setRequired(true)
  )
  .addChannelOption((option: $TSFixMe) => option
  .setName('チャンネル')
